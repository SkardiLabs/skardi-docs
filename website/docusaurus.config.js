...
const config = {
  title: 'Skardi',
  tagline: 'Spark for Agents — a data platform that gives AI agents full data autonomy so every dataset in your stack becomes something an agent can actually use.',
